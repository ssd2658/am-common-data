...
INSERT INTO portfolios (id, name, description, owner, currency, type, status, created_at, updated_at)
VALUES 
    ('123e4567-e89b-12d3-a456-426614174000', 'Growth Portfolio', 'Long-term growth investment portfolio', 'John Doe', 'USD', 'GROWTH', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('123e4567-e89b-12d3-a456-426614174001', 'Dividend Portfolio', 'Income focused portfolio', 'Jane Smith', 'USD', 'INCOME', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
